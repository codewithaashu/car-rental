      ...
      <div className="flex flex-col p-10 w-4/5 items-center gap-8">
        ...
        <div className="flex flex-col gap-3">
          <h2 className="text-base font-medium">
            This document is an electronic record in accordance with Information
            ...
            amended by the Information Technology Act, 2000 and other applicable
            laws. This electronic record is generated by a computer system and
            does not require any physical or digital signatures to make the
          ...
          <div className="text-base">
            ...
            the Website. If any provision of the Terms of Use is deemed invalid
            ...
            of the Terms of Use, which shall remain in full force and effect. No
            waiver of any provision of these Terms of Use shall be deemed a
            further or continuing waiver of such term or any other term, and
            RodBez’s failure to assert any right or provision under these Terms
